...
<meta charset="utf-8">
<title>问题反馈</title>
	<link href="../css/Search_AlterRecord.css" type="text/css" rel="stylesheet"/>
</head>
...
<body>
	...
	<div class="alter">
		<form method="post" action="AlterRecord.php">
			<label style="color: white">修改反馈单号:</label>
			<input type="text" style="width: 200px;height: 27px;" name="problem_id"/>
			<input type="submit" value="跳转" style="margin-right: 40px;width: 60px;height: 30px;text-align: center;"/>
		</form>
	</div>
</body>
</html>